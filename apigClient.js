...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://arvc6smbml.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.photosPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['body', 'Content-Type', 'x-amz-meta-customLabels'], ['body']);
